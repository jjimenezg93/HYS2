...
public class EventDAOUnitTest extends DatabaseQueryUnitTest {
	...
	public void testlistRecomended() throws Exception {
		final List<Event> events = Arrays.asList(
				...
				new Event(2,"Club de lectura", new Timestamp(1433341800),new Timestamp(1433341800),new Timestamp(1434385800),"Hablaremos sobre algun libro, uno diferente cada semana","Literatura", "Vigo","img/prueba2.jpg","Maria")
			);
