...
INSERT INTO `daaexample`.`event` (`nameEvent`,`dateCreate`,`dateInit`,`dateFinal`,`description`,`category`, `place`,`image`,`author`) VALUES ("Pachanga en Coruña","2015-08-13 18:30:00","2015-09-13 18:30:00","2015-09-13 20:30:00","Partido de futbol entre amigos en el campo del campus de ourense","Deportes", "Coruña","img/prueba3.jpg","Pablo");
INSERT INTO `daaexample`.`event` (`nameEvent`,`dateCreate`,`dateInit`,`dateFinal`,`description`,`category`, `place`,`image`,`author`) VALUES ("Parrillada en Vigo","2015-06-03 16:30:00","2015-06-03 16:30:00","2015-06-15 18:30:00","Cada uno debe pagar 5 euros para comprar comida y bebida","Fiesta", "Lugo","img/prueba4.jpg","Pablo");
INSERT INTO `daaexample`.`event` (`nameEvent`,`dateCreate`,`dateInit`,`dateFinal`,`description`,`category`, `place`,`image`,`author`) VALUES ("Fiesta en Vigo","2015-06-03 16:30:00","2015-06-03 16:30:00","2015-06-15 18:30:00","Cada uno debe pagar 5 euros para comprar comida y bebida","Fiesta", "Ourense","img/prueba4.jpg","Pablo");
...
INSERT INTO `daaexample`.`event` (`nameEvent`,`dateCreate`,`dateInit`,`dateFinal`,`description`,`category`, `place`,`image`,`author`) VALUES ("Literatura en Coruña","2015-06-03 16:30:00","2015-06-03 16:30:00","2015-06-15 18:30:00","Cada uno debe pagar 5 euros para comprar comida y bebida","Literatura", "Coruña","img/prueba4.jpg","Pablo");
